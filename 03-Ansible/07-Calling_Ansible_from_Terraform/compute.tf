...
resource "null_resource" "grafana_install" {
  ...
  provisioner "local-exec" {
    command = "ansible-playbook -i aws_hosts --key-file /home/ubuntu/.ssh/mtckey /home/syed/sample/devops-in-the-cloud/03-Ansible/08-Waiting_for_EC2/grafana-playbook.yml"
  }
}
